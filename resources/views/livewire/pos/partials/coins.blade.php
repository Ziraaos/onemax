                    ...
                    <div class="card-body">
                        <div class="input-group input-group-md mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text input-gp hideonsm" style="background-color: #3B3F5C; color: white">Efectivo F8
                                </span>
                            </div>
                        ...
                        <h4 class="text-info">Cambio: Bs. {{ number_format($change, 2) }}</h4>
